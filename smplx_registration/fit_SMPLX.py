...
def fit_SMPLX(scans, pose_files=None, gender='male', save_path=None, display=None):
    """
    :param save_path:
...
if __name__ == "__main__":
    ...
    _, _, _ = fit_SMPLX([args.scan_path], pose_files = [args.pose_file], display=args.display, save_path=args.save_path, gender=args.gender)